# V3.0 - 2/26/2017 - Simple Example script for Joying 2GB Sofia 
#
...
case $key in
        27) # BTPHONE/PTT - call google voice search
		$gvc
	;;

        9) # NAVI - Toggle between Google Maps and last app
		#
	...
	$pause;  
	 ...
	 ;;
        ...
        *) # DO NOT REMOVE - Pass any other keys pressed as keyevent 
